        ...
        **kwargs,
        ...
        if GLOBAL_L in range(32):
            if  GLOBAL_L == 11:
                ...
                torch.save(query_states, os.path.join(save_dir, f"GPT2_key_vector_layer1_heatmap.pt"))
                torch.save(key_states, os.path.join(save_dir, f"GPT2_query_vector_layer1_heatmap.pt"))
                torch.save(value_states, os.path.join(save_dir, f"GPT2_value_vector_layer1_heatmap.pt"))
                exit()
